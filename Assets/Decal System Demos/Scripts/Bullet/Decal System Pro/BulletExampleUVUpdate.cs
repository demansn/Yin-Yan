			...
			while (true) {
				if (m_DecalProjectors.Count > 0) {
					foreach (DecalProjector l_DecalProjector in m_DecalProjectors) {
						...
						l_UVRectangleIndex = l_UVRectangleIndex + 1;
						if (l_UVRectangleIndex >= m_DecalsInstance.CurrentUvRectangles.Length) {
							l_UVRectangleIndex = 0;
						}
						l_DecalProjector.uv1RectangleIndex = l_UVRectangleIndex;
						m_DecalsMesh.UpdateProjectedUV (l_DecalProjector);
					}

					m_DecalsInstance.UpdateProjectedUVs (m_DecalsMesh);
				}
...
//						int l_UVRectangleIndex = l_DecalProjector.uv1RectangleIndex;
//						l_UVRectangleIndex = l_UVRectangleIndex + 1;
//						if (l_UVRectangleIndex >= m_Decals.CurrentUvRectangles.Length) {
//							l_UVRectangleIndex = 0;
//						}
//						l_DecalProjector.uv1RectangleIndex = l_UVRectangleIndex;
//						m_DecalsMesh.UpdateProjectedUV (l_DecalProjector);
//					}
//
//					m_Decals.UpdateProjectedUVs (m_DecalsMesh);
//				}
//
//				yield return (new WaitForSeconds (1.0f));
//			}
